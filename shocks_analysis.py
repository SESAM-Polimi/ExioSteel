...
for scenario in scenarios:
    for year in years:
        ...
        f_ghg_act.T.to_csv('results/GHG footprints/f_ghg_act_{}_{}.csv'.format(scenario,str(year)))        
        f_ghg_com.T.to_csv('results/GHG footprints/f_ghg_com_{}_{}.csv'.format(scenario,str(year)))
        ...
        f_ex_ghg_act.T.to_csv('results/GHG footprints/f_ex_ghg_act_{}_{}.csv'.format(scenario,str(year)))
        ...
        f_ene_com.T.to_csv('results/Energy footprints/f_ene_com_{}_{}.csv'.format(scenario,str(year)))
        ...
        f_ex_ene_act.to_csv('results/Energy footprints/f_ex_ene_act_{}_{}.csv'.format(scenario,str(year)))
